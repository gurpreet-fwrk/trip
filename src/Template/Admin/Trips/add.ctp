                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="faq1" class="form-control valid" required="required" id="faq1" rows="5" aria-invalid="false"></textarea>
                        </div>
                        
                        <div class="form-group">
                            Things to prepare for the Trip?
                            Is there anything travelers should prepare for this trip?
                            <textarea name="faq2" class="form-control" required="required" id="faq2" rows="5"></textarea>
                        </div>
                    </div>  
                ...
                <div class="box-body">
                        ...
                        <div class="panel box box-primary">
                            <div class="box-header with-border">
                                <h4 class="box-title">
                                    <div class="form-group">
                                        <div class="radio">    
                                            <input type='radio' name='include_exclude' value='all_inclusive' required /> All inclusive 
                                        </div>
                                    </div>    
                                </h4>
                            </div>
                        ...
                        <div class="panel box box-primary">
                            <div class="box-header with-border">
                                <h4 class="box-title">
                                    <div class="form-group">
                                        <div class="radio">    
                                            <input type='radio' name='include_exclude' value='food_excluded' required /> Food Excluded 
                                        </div>
                                    </div>    
                                </h4>
                            </div>
                        ...
                        <div class="panel box box-primary">
                            <div class="box-header with-border">
                                <h4 class="box-title">
                                    <div class="form-group">
                                        <div class="radio">    
                                            <input type='radio' name='include_exclude' value='all_excluded' required /> Food, Transportation, Admission fee excluded
                                        </div>
                                    </div>    
                                </h4>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="extra_expense_en" class="form-control valid" placeholder="e.g. your pocket money" required="required" id="extra-expense-en" rows="5" aria-invalid="false"></textarea>
                        </div>
                    </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="<?php echo $extracondition['id']; ?>" name="extracondition_id[]"> <?php echo $extracondition['title_en']; ?>
                                </label>
                            </div>
                        </div>
                        <?php } ?>
...
$("input[name='include_exclude']:first").trigger('click');
$("input[name='include_exclude']:first").parent().parent().parent().parent().next('div').addClass('in'); 
