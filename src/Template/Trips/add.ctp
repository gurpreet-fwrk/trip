            ...
            <div id="London" class="tabcontent">
              ...
              <div class="basetrip">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <?php echo $this->Form->select('stopped_locations', $locations, ['class' => 'form-control js-example-basic-multiple','multiple' => 'multiple']); ?>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9">
                    <?php echo $this->Form->select('activities', $activities, ['class' => 'form-control js-example-basic-multiple','multiple' => 'multiple']); ?>
                  </div>
                </div>
                            ...
                            <div class="conditions-top">
                              <?php foreach ($transportation->transportationvehicles as $vehicle) { ?>
                                <div class="col-md-4 padding-left-n">
                                    <div class="form-group">
                                        <input type="radio" value="<?php echo $vehicle['id'] ?>" name="Casual" id='c11'>
